  ...
  return (
    <div>
      <PageHeader
        ...
        subTitle={<Space>
          {detailObj?.category?.title}
          <svg width="1em" height="1em" fill={starState ? 'hotpink' : 'currentColor'} viewBox="0 0 1024 1024" onClick={() => handleStart()} style={{ cursor: 'pointer' }}>
      ...
      >
        <Descriptions size="small" column={3}>
          ...
          <Descriptions.Item label="访问数量">
            <span style={{ color: 'green' }}>{detailObj?.view}</span>
          </Descriptions.Item>
          <Descriptions.Item label="点赞数量">
            <span style={{ color: 'green' }}>{detailObj?.star}</span>
          </Descriptions.Item>
